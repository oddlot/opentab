package io.oddlot.opentab.tabs
...
import io.oddlot.opentab.viewmodels.TabViewModel
import io.oddlot.opentab.R
import io.oddlot.opentab.RequestCodes
import io.oddlot.opentab.app.MainActivity
import io.oddlot.opentab.transactions.TransactionsAdapter
...
import io.oddlot.opentab.transactions.TransactionActivity
        ...
        return when (item.itemId) {
            ...
            R.id.menu_share_tab -> {
                val i = Intent(Intent.ACTION_SEND).apply {
                    ...
                    val userName = PreferenceManager.getDefaultSharedPreferences(this@TabActivity).getString(PreferenceKeys.USER_NAME, "NONAME")
