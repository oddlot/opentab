    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        privacyTV.setOnClickListener {
            val builder = AlertDialog.Builder(this, R.style.AlertDialog).apply {
                ...
                setMessage("$appName does not collect your personal data.  Information is kept only on your device and is never accessed by the developers of $appName or any third parties.")
            }
