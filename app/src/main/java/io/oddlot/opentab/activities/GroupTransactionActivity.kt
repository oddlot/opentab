...
import io.oddlot.opentab.adapters.AllocationAdapter
...
import io.oddlot.opentab.viewmodels.GroupExpenseViewModel
import io.oddlot.opentab.viewmodels.GroupExpenseViewModelFactory
        ...
        CoroutineScope(IO).launch {
            ...
            withContext(Main) {
                mViewModel = ViewModelProviders
                    .of(this@GroupTransactionActivity, GroupExpenseViewModelFactory(groupExpense))
...
//                               id = 1
                    ...
                    Toast.makeText(this@GroupTransactionActivity, e.message, Toast.LENGTH_LONG).show()
                }
                true
            }
    ...
    private fun setUpUi() {
        ...
        datePicker.setOnClickListener {
            DatePickerDialog(this@GroupTransactionActivity).apply {
        ...
        payeeAllocation.layoutManager = LinearLayoutManager(this@GroupTransactionActivity)
