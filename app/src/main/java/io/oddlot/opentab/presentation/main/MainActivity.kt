...
import io.oddlot.opentab.presentation.misc.AboutActivity
import io.oddlot.opentab.presentation.misc.SettingsActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var bsd: LinearLayoutCompat
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.statusBarColor = ContextCompat.getColor(this, R.color.AppTheme)
...
//        navController.navigate(R.id.action_nav_home_to_settingsFragment)
        ...
        bsd = findViewById<LinearLayoutCompat>(R.id.bottomSheet)
        ...
        findViewById<FloatingActionButton>(R.id.fab)
            ...
            setOnClickListener {
                // 'context' uses FAB theme, 'this@MainActivity' uses app theme
